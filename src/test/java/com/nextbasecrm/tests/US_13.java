...
public class US_13 {
    ...
    public void TC1_testUser() {
         ...
         *         Users click the MORE tab and select APPRECIATION
        ...
        nextbaseCrmProject.appreciationUnderMore.click();

        Driver.getDriver().switchTo().frame(nextbaseCrmProject.messageFrame);
        nextbaseCrmProject.textMessageArea.sendKeys(faker.bothify("I appreciate it to Cydeo ###"));
    ...
    public void TC2_testUser() {
        ...
        nextbaseCrmProject.inputUsername.sendKeys(ConfigurationReader.getProperty("next.username2"));
        nextbaseCrmProject.inputPassword.sendKeys(ConfigurationReader.getProperty("next.password"));
        BrowserUtils.sleep(1);
        nextbaseCrmProject.signInButton.click();
        BrowserUtils.sleep(1);
